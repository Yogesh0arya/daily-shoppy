    ...
    <>
      <div className="bg-[url('/images/horizontal.jpg')] bg-cover text-center text-white">
        <div className="bg-yellow-500 py-12">
          <h1 className="text-xl font-bold md:text-2xl xl:text-4xl 2xl:text-5xl mb-3">
            We Offer You an Unforgettable{" "}
          </h1>
          <h1 className="text-xl font-bold md:text-2xl xl:text-4xl 2xl:text-5xl mb-3">
            Delivery Experience
          </h1>
          <button className=" bg-black  py-1 px-2 lg:px-3 lg:py-2 xl:text-lg rounded-full">
            Order Online
          </button>
        </div>
      </div>
      ...
      <div className="bg-[rgb(27,22,22)] text-white py-24">
        <div className="max-w-6xl mb-6 mx-auto px-5 grid grid-cols-1 lg:grid-cols-3 gap-x-5 gap-y-12 text-center">
          ...
          <div>
            ...
            <div className="flex gap-3 sm:space-x-1 mt-4 justify-center">
              <FaYoutube className="w-10 h-10 p-3 bg-yellow-700 text-white hover:bg-white hover:text-red-500 rounded-full" />
              <FaTwitter className="w-10 h-10 p-3 bg-yellow-700 text-white hover:bg-white hover:text-blue-500 rounded-full" />
              <FaInstagram className="w-10 h-10 p-3 bg-yellow-700 text-white hover:bg-white hover:text-pink-500 rounded-full" />
              <FaLinkedinIn className="w-10 h-10 p-3 bg-yellow-700 text-white hover:bg-white hover:text-blue-500 rounded-full" />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-5 flex flex-wrap lg:text-lg justify-center mt-12 gap-x-5 text-yellow-500">
        ...
        <p className="max-w-6xl mx-5 lg:mx-auto text-center mt-3 md:text-lg">
          Copyright © 2021 Daily Shoppy All Rights Reserved Designed By Dipesh.
        </p>
      </div>
    </>
  );
